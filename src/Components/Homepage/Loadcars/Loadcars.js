      ...
      <div className="loadcar-wrapper"> 
        <div className="loadcar-container">
          <h2 className="loadcar-header">
            ...
            <h5>
              Interdum neque adipiscing eros enim velit suspendisse pulvinar
              lacus rhoncus varius. Inceptos lobortis. Sociosqu integer litora
              vulputate neque.
            </h5>
          </h2>
                ...
                <div className="col " key={car._id}>
                  <div className="card">
                    ...
                    <div className="card-body">
                      ...
                      <h5 className="card-title my-4"> ${car.price}</h5>
